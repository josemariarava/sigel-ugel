            ...
            <Table className="w-full">
                <TableHeader className="sticky top-0 z-10 bg-white">
                    <TableRow>
                        ...
                        <TableHeaderCell className="hidden md:table-cell"><span className="font-semibold">Código TI</span></TableHeaderCell>
                    ...
                    {paginatedData.length === 0 ? (
                        ...
                        paginatedData.map((bien) => (
                            <TableRow key={bien.id} className={`hover:bg-gray-50 transition-colors ${selectedIds.has(bien.id) ? 'bg-blue-50' : ''}`}>
                                ...
                                <TableCell className="hidden md:table-cell font-mono text-xs">{bien.codigo_ti || '-'}</TableCell>
                                <TableCell className="hidden sm:table-cell">
